...
nodejs="cd /home/pierre/webapps/MyReact/api-rest-red-social && npm run start"
#vite="cd ~/webapps/MyReact/master-react/15-blog && npm run dev"
...
#gnome-terminal --tab --title "VITE" -- bash -c "eval $vite; exec bash -i"
